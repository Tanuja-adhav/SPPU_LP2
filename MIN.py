...
#Enter edge info (source, destination, cost): 1 2 2
#Enter edge info (source, destination, cost): 2 3 3
#Enter edge info (source, destination, cost): 3 1 10
#Minimum Spanning Tree: [('2', 2), ('3', 3)]
#Total Cost: 5
